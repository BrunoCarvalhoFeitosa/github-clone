...
import Discount from "@/components/Collaboration/Discount"
...
const Collaboration = () => {
    ...
    return (
        <div className="max-w-[1280px] mx-auto">
            <div className="flex md:pl-7 space-x-3 md:space-x-10">
                ...
                >
                    <div>
                        ...
                        >
                            <span className="text-[#ffa28b] mr-2">
            ...
            <HoverCard backgroundColor="#ffa28b" left="" direction="left">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <div className="text-[#7d8590] my-2">
                                    Homebrew
                                </div>
                ...
                >
                    <a
                        href=""
                        target="_blank"
                        className="rounded-md bg-[#161b22] border-[0.5px] border-[#30363d] flex flex-col items-center m-2 p-6 outline-none"
                    >
                        <img
