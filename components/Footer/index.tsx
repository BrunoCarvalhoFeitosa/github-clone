const Footer = () => {
    return (
        <div>
            <footer className="relative max-w-[1280px] mx-auto px-5 z-[2]">
                <div>
                    <ul className="lg:w-9/12 pt-16 space-y-1 text-[14px] text-[#7D8590]">
                        <li>
                            <sup id="footnote-1" className="mr-2">1</sup>
                        ...
                        <li>
                            <sup id="footnote-2" className="mr-2">2</sup>
                            GitHub, Octoverse 2022 The state of open source software.
                        </li>
                    </ul>
                </div>
                <div className="relative footer pt-14 break-words">
                    <div className="relative max-w-[1280px] mx-auto overflow-hidden z-[2]">
                        <div className="flex flex-col lg:flex-row py-10 px-4 mb-8 space-x6">
                            <div className="mb-12 px-2">
                                <a href="/" className="color-fg-subtitle">
                                    <svg
                                        aria-hidden="true"
                                        viewBox="0 0 45 16"
                                        version="1.1"
                                ...
                                <div className="text-white">
                                    ...
                                    <a
                                        href=""
                                        className="mb-6 px-6 py-3 border-[0.5px] text-[17px] font-semibold border-gray-600 hover:border-white rounded-lg"
                                    >
                                        Subscribe
                                    </a>
                                </div>
                            </div>
                            <div className="w-full lg:flex justify-between grid-cols-2 grid md:grid-cols-4 gap-6">
                                <div className="text-[#7D8590]">
                                    <h2 className="mb-4 font-mono font-bold underline">
                                        Product
                                    </h2>
            ...
            <div className="bg-[#161B22]">
                <div className="py-6 px-4 md:flex flex-row-reverse justify-between items-center text-[12px]">
                    <ul className="flex items-center max-md:mb-4">
                        <li className="mr-4">
                            <a href="">
                                <img
                                    src="https://github.githubassets.com/images/modules/site/icons/footer/x.svg"
                                    height="10"
                                    width="16"
                                    className="d-block"
                                    loading="lazy"
                    ...
                    <ul className="flex flex-wrap items-center mb-4 sm:mb-0 text-[#7D8590]">
                        <li className="mr-3">
                            © 2023 GitHub, Inc.
                        </li>
                        <li className="mr-3">
