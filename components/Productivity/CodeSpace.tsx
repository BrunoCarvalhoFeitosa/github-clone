    ...
    return (
        <div className="relative flex md:pl-10">
            ...
            <div className="pl-6 lg:pl-24 md:pl-16">
                <div className="flex max-md:flex-col-reverse md:flex-row items-center lg:gap-x-5 my-8 sm:my-12 md:my-16 pb-6 md:pb-20">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <path
                                        fill="currentColor"
                                        d="M7.28033 3.21967C6.98744 2.92678 6.51256 2.92678 6.21967 3.21967C5.92678 3.51256 5.92678 3.98744 6.21967 4.28033L7.28033 3.21967ZM11 8L11.5303 8.53033C11.8232 8.23744 11.8232 7.76256 11.5303 7.46967L11 8ZM6.21967 11.7197C5.92678 12.0126 5.92678 12.4874 6.21967 12.7803C6.51256 13.0732 6.98744 13.0732 7.28033 12.7803L6.21967 11.7197ZM6.21967 4.28033L10.4697 8.53033L11.5303 7.46967L7.28033 3.21967L6.21967 4.28033ZM10.4697 7.46967L6.21967 11.7197L7.28033 12.7803L11.5303 8.53033L10.4697 7.46967Z"></path><path className={` text-white transition ease-in duration-150 ${hovered ? "opacity-100" : "opacity-0"}`}
                                        stroke="currentColor"
                                        d="M1.75 8H11"
                                        strokeWidth="1.5"
                                        strokeLinecap="round"
                    ...
                    <div className="w-full py-4 px-6">
                        <div className="relative">
                            <div className="flex flex-row relative">
                                ...
                                >
                                    <div className="border-2 border-black overflow-hidden rounded-md">
                                        <img
                                            src="/images/pic.png"
                                ...
                                <motion.div
                                    ...
                                    className="overflow-hidden max-w-[373px] bottom-0 rounded-md relative hidden sm:block build-in-animate border-2 border-black"
                                >
                                    <img
