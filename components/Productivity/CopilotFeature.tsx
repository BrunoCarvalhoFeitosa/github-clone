...
const CopilotFeature = (props: Props) => {
    ...
    return (
        <HoverCard
            ...
            left="0"
        >
            <div className="md:flex justify-between flex-1 flex-col lg:space-y-20 p-8 sm:p-10 lg:py-16 lg:pr-32">
                <div>
                    <p className="text-xl md:text-2xl mb-6 font-medium text-[#7D8590]">
                        <span className="font-medium text-white mr-2">
                            GitHub Copilot
                        </span>
                        is your AI pair programmer that empoyers you to complete tasks 55% faster by turning natural language prompts into coding suggestions.
                    </p>
                </div>
                <div>
                    <a
            ...
            <div className="flex-1 rounded-s-lg z-[1]">
                <div className="text-left border-[0.5px] bg-[#161B22] border-[#30363D] rounded-lg sm:ml-10 sm:mr-10 md:mr-0 lg:mr-10 mn-16 ml-3 mr-3 md:mt-10 md:ml-0 text-[161B22]">
                    <div>
                        <div className="pt-2 px-2 mb-0 border-b-[0.5px] border-[#30363D] overflow-x-auto">
                            <div className="flex items-center bg-[#161B22] text-[#7D8590] tab-nav">
                                <button
                                    type="button"
                                    className={`flex items-center py-2 px-4 ${showPy ? "border-[0.5px] rounded-t-md border-b-[0] border-[#30363D] bg-[#0D1117] text-white": ""}`}
                                    onClick={() => {
                                        setShowPy(true)
                                        setShowGo(false)
                                        setShowJs(false)
                        ...
                        <div className={`relative p-4 bg-[#0D1117] ${showPy ? "" : "hidden"}`}>
                            <div className="flex">
                                ...
                                <div key={count} className="flex-1 rounded-b-md overflow-x-auto text-white">
                                    <pre className="">
                                    ...
                                    <pre className="">
                                        ...
                                        >
                                            <motion.span
                                                variants={item}
                                                className="pl-k js-type-letters mr-1"
                                            >
                                                def
                                            </motion.span>
                                            <motion.span
                                            ...
                                            <motion.span
                                                variants={item}
                                                className="pl-s1 ml-1 js-type-letters"
                                            >
                                                y_values
                                            </motion.span>
                                            <motion.span
                                    ...
                                    >
                                        <pre className="bg-[#388bfd1a] pl-10">
                                            <span>
                            ...
                            <div className="absolute w-full z-[1] bottom-[-44px] md:bottom-0 lg:bottom-[-60px] left-0 flex items-center justify-center mb-5">
                                <button
                            ...
                            <div className="flex">
                                ...
                                <pre className="">
                                    ...
                                    >
                                        ...
                                        <motion.span
                                            variants={item}
                                            className="pl-1 js-type-letters"
                                        >
                                            minutes
                                        </motion.span>
                                        <motion.span
                    ...
                    <div className={`p-4 relative bg-[#0d1117] ${showGo ? "" : "hidden"}`}>
                        <div className="flex">
                            ...
                            <div key={count} className="flex-1 overflow-x-auto text-white rounded-b-md">
                                ...
                                <pre className="">
                                    ...
                                    >
                                        ...
                                        <motion.span
                                            variants={item}
                                            className="pr-1 js-type-letters"
                                        >
                                            func
                                        </motion.span>
                                        <motion.span
                                        ...
                                        <motion.span
                                            variants={item}
                                            className="pl-k pl-1 js-type-letters"
                                        >
                                            func
                                        </motion.span>
                                        <motion.span
                                        ...
                                        <motion.span
                                            variants={item}
                                            className="pl-smi px-1 js-type-letters"
                                        >
                                            int
                                        </motion.span>
                                        <motion.span
                                ...
                                >
                                    ...
                                    <pre className="bg-[#388bfd1a]">
                                        <span className="pl-6">
                                            <span className="pl-k pr-1">
                                                return
                                            </span>
                                            <span className="pl-k">
                                                func
                                            </span>(
                                            <span className="pl-s1 pr-1">
                                                n
                                            </span>
                                            <span className="pl-smi">
                                                int
                                            </span>)
                                            <span className="pl-smi px-2">
                                                int
                                            </span>{"{"}
                                        </span>
                                    </pre>
                            ...
                            <div
                                onClick={() => setCount(count + 1)}
                                className="absolute w-full z-[1] bottom-[-44px] md:bottom-6 lg:bottom-[-52px] left-0 flex items-center justify-center mb-5"
                            >
