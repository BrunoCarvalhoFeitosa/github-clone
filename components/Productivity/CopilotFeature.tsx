...
const CopilotFeature = (props: Props) => {
    ...
    return (
        <HoverCard
            ...
            left="0"
        >
            <div className="md:flex justify-between flex-1 flex-col md:space-y-20 p-8 sm:p-10 lg:py-16 lg:pr-32">
                <div>
            ...
            <div className="flex-1 rounded-s-lg z-[1]">
                <div className="text-left border-[0.5px] bg-[#161B22] border-[#30363D] rounded-lg sm:ml-10 sm:mr-10 mn-16 ml-3 mr-3 md:mt-10 md:ml-0 text-[161B22]">
                    <div>
                    ...
                    <div className={`p-4 relative bg-[#0d1117] ${showGo ? "" : "hidden"}`}>
                        <div className="flex">
                            ...
                            <div
                                onClick={() => setCount(count + 1)}
                                className="absolute w-full z-[1] bottom-[-52px] left-0 flex items-center justify-center mb-5"
                            >
