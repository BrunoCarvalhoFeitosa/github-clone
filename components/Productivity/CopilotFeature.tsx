                ...
                <div className="text-left border-[0.5px] bg-[#161B22] border-[#30363D] rounded-lg sm:ml-10 sm:mr-10 md:mr-0 lg:mr-10 mn-16 ml-3 mr-3 md:mt-10 md:ml-0 text-[161B22]">
                    <div>
                        ...
                        <div className={`relative p-4 bg-[#0D1117] ${showPy ? "" : "hidden"}`}>
                            ...
                            <div className="absolute w-full z-[1] bottom-[-60px] md:bottom-0 lg:bottom-[-60px] left-0 flex items-center justify-center mb-5">
                                <button
                    ...
                    <div className={`p-4 relative bg-[#0d1117] ${showGo ? "" : "hidden"}`}>
                        <div className="flex">
                            ...
                            <div
                                onClick={() => setCount(count + 1)}
                                className="absolute w-full z-[1] bottom-[-52px] md:bottom-6 lg:bottom-[-52px] left-0 flex items-center justify-center mb-5"
                            >
